...
│
└── shared/
    ├── base_agent.py     # Shared base class for agent lifecycle and context handling
    ├── tool_registry.py  # Dynamic tool discovery and MCP integration
...
| **Tool Management**   | Dynamic discovery via the MCP registry and `tool_registry.py`.                             |
